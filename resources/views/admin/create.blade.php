	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="POST" action="{{route('administrateur.store')}}">
                                    @csrf
                                    @method("POST")
								    ...
								    <div class="mb-3">{{--nom --}}
									    ...
									    <input type="text" class="form-control" id="setting-input-1" placeholder="Entrer le nom complet" name="name" value="{{ old('name') }}" required>
											@error('name')
