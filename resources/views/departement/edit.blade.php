    ...
    <h1 class="app-page-title">Departements</h1>
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Modifier un département </div>
	                </div>
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="POST" action="{{route('departement.update', $departement->id)}}">
								    ...
								    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-1" placeholder="Entrer le nom du département" name="name" value="{{ $departement->name }}" required>
										@error('name')
