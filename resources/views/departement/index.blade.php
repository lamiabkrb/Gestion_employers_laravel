										...
										<tbody>
                                            @forelse ($departements as $departement)
                                                <tr>
                                                    ...
                                                    <td class="cell"><a class="btn-sm app-btn-secondary" href="{{route('departement.edit', $departement->id)}}">Editer</a>
														             <a class="btn-sm app-btn-secondary" href="{{route('departement.delete',$departement->id)}}">Retirer</a></td>
                                                </tr>
                                            @empty
                                                <tr>
