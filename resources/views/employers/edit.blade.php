...
@section('content')
    ...
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            <h3 class="section-title">Editer un employé</h3>
            <div class="section-intro">Modifier ici les informations de l'employé</div>
        </div>
                ...
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{route('employer.update', $employer->id)}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-1" placeholder="Entrer le nom de l'employer" name="first_name" value="{{ $employer->nom }}" required>
                                @error('first_name')
                                <div class="text-danger">{{$message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-2" name="last_name" placeholder="Entrer le prenom de l'employer" value="{{ $employer->prenom }}" required>
                            @error('last_name')
                                <div class="text-danger">{{$message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="setting-input-3" placeholder="Entrer le mail" value="{{ $employer->email }}" name="email">
                            @error('email')
                                <div class="text-danger">{{$message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3" placeholder="Entrer le contact" value="{{ $employer->contact }}" name="phone">
                            @error('phone')
                                <div class="text-danger">{{$message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="setting-input-3" placeholder="Entrer le montant journalier" value="{{ $employer->montant_journalier }}" name="montant_journalier">
